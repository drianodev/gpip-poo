...
public class PatrimonioTest {
    ...
    public void testGetDataAquisicao() {
        Date data = new Date();
        Patrimonio patrimonio = new Patrimonio(1, "PT123", "Descrição do Patrimônio", "Bom estado", data, null, null);
        assertEquals(data, patrimonio.getDataAquisicao());
    }

    @Test
    public void testGetSala() {
        Sala sala = new Sala(1, 101, 1, null);
        Patrimonio patrimonio = new Patrimonio(1, "PT123", "Descrição do Patrimônio", "Bom estado", new Date(), null, sala);
